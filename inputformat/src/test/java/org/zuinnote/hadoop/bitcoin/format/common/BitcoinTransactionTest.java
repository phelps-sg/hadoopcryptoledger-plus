...
public class BitcoinTransactionTest {
    ...
    public void getTransactionHash() throws IOException {
        ...
        UIntVar txInScriptLength = new UIntVar(new byte[]{(byte) 0x4D});
...
//        byte[] inCounter = new byte[]{0x01};
        ...
        UIntVar txInScriptLength = new UIntVar(new byte[]{(byte) 0x17});
        ...
        BitcoinTransaction randomScriptWitnessTransaction =
            new BitcoinTransaction(version, marker, flag, inCounter, outCounter, randomScriptWitnessInput,
                                    randomScriptWitnessOutput, randomScriptWitnessSWI, lockTime);

...
public class BitcoinTransactionTest {
    ...
    public void getTransactionHash() throws IOException {
        ...
        UInt32 version = new UInt32(1);
        UIntVar inCounter = new UIntVar(1);
        HashSHA256 previousTransactionHash = new HashSHA256(new byte[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00});
        UInt32 previousTxOutIndex = new UInt32(4294967295L);
...
//        BitcoinTransaction genesisTransaction = new BitcoinTransaction(version, inCounter, genesisInput, outCounter, genesisOutput, lockTime);
    ...
    public void getTransactionHashSegWit() throws IOException {
        ...
        UInt32 version = new UInt32(2);
        byte marker = 0x00;
        byte flag = 0x01;
//        byte[] inCounter = new byte[]{0x01};
        UIntVar inCounter = new UIntVar(1);
        HashSHA256 previousTransactionHash = new HashSHA256(new byte[]{(byte) 0x07, (byte) 0x21, (byte) 0x35, (byte) 0x23, (byte) 0x6D, (byte) 0x2E, (byte) 0xBC, (byte) 0x78, (byte) 0xB6, (byte) 0xAC, (byte) 0xE1, (byte) 0x88, (byte) 0x97, (byte) 0x03, (byte) 0xB1, (byte) 0x84, (byte) 0x85, (byte) 0x52, (byte) 0x87, (byte) 0x12, (byte) 0xBD, (byte) 0x70, (byte) 0xE0, (byte) 0x7F, (byte) 0x4A, (byte) 0x90, (byte) 0x11, (byte) 0x40, (byte) 0xDE, (byte) 0x38, (byte) 0xA2, (byte) 0xE8});
        UInt32 previousTxOutIndex = new UInt32(1L);
...
//        byte[] noOfStackItems = new byte[]{0x02};
        ...
        UIntVar segwitnessLength_1 = new UIntVar(new byte[]{(byte) 0x48});
...
//        byte[] segwitnessLength_2 = new byte[]{(byte) 0x21};
        UIntVar segwitnessLength_2 = new UIntVar(new byte[]{(byte) 0x21});
...
//        BitcoinTransaction randomScriptWitnessTransaction = new BitcoinTransaction(marker, flag, version, inCounter, randomScriptWitnessInput, outCounter, randomScriptWitnessOutput, randomScriptWitnessSWI, lockTime);
        BitcoinTransaction randomScriptWitnessTransaction =
//                new BitcoinTransaction(marker, flag, version, inCounter, randomScriptWitnessInput, outCounter, randomScriptWitnessOutput, randomScriptWitnessSWI, lockTime);
            new BitcoinTransaction(version, marker, flag, inCounter, outCounter, randomScriptWitnessInput, randomScriptWitnessOutput, randomScriptWitnessSWI, lockTime);
